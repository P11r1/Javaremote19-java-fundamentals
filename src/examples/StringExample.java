...
public class StringExample {
    ...
    public static void main(String[] args) {
        ...
        firstName.concat(lastName); // option 2

        String city = "Parnu";

        String ageString = "My ages is : " + 3 + ". I ive in " + city + ". My name is: " + fullName;
        ...
        String s3 = new String("Sibul"); // Heap (1)//589498465
        String s4 = new String("Sibul"); // Heap (1)//564864651

        System.out.println(s1 == s3); // False because stored in different memory
        System.out.println(s1 == s2);
        System.out.println(s3 == s4); // (1)false because the memory values are different

        System.out.println(s1.equals(s3)); // True because .equals compares also the memory
